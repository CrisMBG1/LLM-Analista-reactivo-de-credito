...
def create_company_report_pdf():
    ...
    c.drawString(100, 580, "Activos Totales: $5,000,000 COP")
    c.drawString(100, 560, "Pasivos Totales: $1,200,000 COP")
    c.drawString(100, 540, "Capital Contable: $3,800,000 COP")
